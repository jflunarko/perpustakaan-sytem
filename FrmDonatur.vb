...
Public Class FrmDonatur
    ...
    Private Sub FrmPenerbit_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        'TODO: This line of code loads data into the 'PerpustakaanDataSet9.Donatur' table. You can move, or remove it, as needed.
        Me.DonaturTableAdapter.Fill(Me.PerpustakaanDataSet9.Donatur)
    ...
    Private Sub btnCreate_Click(sender As Object, e As EventArgs) Handles btnCreate.Click
        Try
            ...
            ' Insert new record
            query = "INSERT INTO Donatur (nama, alamat, telepon) VALUES (@nama, @alamat, @telepon)"
    ...
    Private Sub btnUpdate_Click(sender As Object, e As EventArgs) Handles btnUpdate.Click
        Try
            ...
            Dim cmdCheck As New SqlCommand("SELECT * FROM Donatur WHERE id = @id", conn)
