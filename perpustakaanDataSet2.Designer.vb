...
Partial Public Class perpustakaanDataSet2
    ...
    Partial Public Class PenerbitDataTable
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")>  _
        Public Overloads Function AddPenerbitRow(ByVal id As Integer, ByVal nama As String, ByVal telepon As String, ByVal alamat As String) As PenerbitRow
            Dim rowPenerbitRow As PenerbitRow = CType(Me.NewRow,PenerbitRow)
            Dim columnValuesArray() As Object = New Object() {id, nama, telepon, alamat}
...
Namespace perpustakaanDataSet2TableAdapters
    ...
    Partial Public Class BukuTableAdapter
        ...
        Public Overloads Overridable Function Fill(ByVal dataTable As perpustakaanDataSet2.BukuDataTable) As Integer
        ...
        Public Overloads Overridable Function GetData() As perpustakaanDataSet2.BukuDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As perpustakaanDataSet2.BukuDataTable = New perpustakaanDataSet2.BukuDataTable()
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As perpustakaanDataSet2.BukuDataTable) As Integer
    ...
    Partial Public Class MahasiswaTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As perpustakaanDataSet2.MahasiswaDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As perpustakaanDataSet2.MahasiswaDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As perpustakaanDataSet2.MahasiswaDataTable = New perpustakaanDataSet2.MahasiswaDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As perpustakaanDataSet2.MahasiswaDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
    ...
    Partial Public Class PenerbitTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.InsertCommand.Connection = Me.Connection
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Penerbit] ([id], [nama], [telepon], [alamat]) VALUES (@id, @na"& _ 
                "ma, @telepon, @alamat);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, nama, telepon, alamat FROM Penerbit WHERE (i"& _ 
                "d = @id)"
            Me._adapter.InsertCommand.CommandType = Global.System.Data.CommandType.Text
            ...
            Me._adapter.UpdateCommand = New Global.System.Data.SqlClient.SqlCommand()
            Me._adapter.UpdateCommand.Connection = Me.Connection
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Penerbit] SET [id] = @id, [nama] = @nama, [telepon] = @telepon, [al"& _ 
                "amat] = @alamat WHERE (([id] = @Original_id) AND ([nama] = @Original_nama) AND ("& _ 
                "[telepon] = @Original_telepon) AND ((@IsNull_alamat = 1 AND [alamat] IS NULL) OR"& _ 
                " ([alamat] = @Original_alamat)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT id, nama, telepon, alamat FROM Penerbi"& _ 
                "t WHERE (id = @id)"
            Me._adapter.UpdateCommand.CommandType = Global.System.Data.CommandType.Text
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Fill, true)>  _
        Public Overloads Overridable Function Fill(ByVal dataTable As perpustakaanDataSet2.PenerbitDataTable) As Integer
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            If (Me.ClearBeforeFill = true) Then
                dataTable.Clear
            End If
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.[Select], true)>  _
        Public Overloads Overridable Function GetData() As perpustakaanDataSet2.PenerbitDataTable
            Me.Adapter.SelectCommand = Me.CommandCollection(0)
            Dim dataTable As perpustakaanDataSet2.PenerbitDataTable = New perpustakaanDataSet2.PenerbitDataTable()
            Me.Adapter.Fill(dataTable)
            Return dataTable
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As perpustakaanDataSet2.PenerbitDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Insert, true)>  _
        Public Overloads Overridable Function Insert(ByVal id As Integer, ByVal nama As String, ByVal telepon As String, ByVal alamat As String) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         ...
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter"),  _
         Global.System.ComponentModel.DataObjectMethodAttribute(Global.System.ComponentModel.DataObjectMethodType.Update, true)>  _
        Public Overloads Overridable Function Update(ByVal id As Integer, ByVal nama As String, ByVal telepon As String, ByVal alamat As String, ByVal Original_id As Integer, ByVal Original_nama As String, ByVal Original_telepon As String, ByVal Original_alamat As String) As Integer
            ...
            If (Original_telepon Is Nothing) Then
                Throw New Global.System.ArgumentNullException("Original_telepon")
            Else
                Me.Adapter.UpdateCommand.Parameters(6).Value = CType(Original_telepon,String)
            End If
            If (Original_alamat Is Nothing) Then
        ...
        Public Overloads Overridable Function Update(ByVal nama As String, ByVal telepon As String, ByVal alamat As String, ByVal Original_id As Integer, ByVal Original_nama As String, ByVal Original_telepon As String, ByVal Original_alamat As String) As Integer
            Return Me.Update(Original_id, nama, telepon, alamat, Original_id, Original_nama, Original_telepon, Original_alamat)
        End Function
    End Class
